	...
	public static WebDriver getWebDriver(Browser browser) {		
		...
		case CHROME:
			...
			System.setProperty("webdriver.chrome.driver",
									System.getProperty("user.dir")+Util.getFileSeparator()+"drivers"+Util.getFileSeparator()+"chromedriver.exe");
		...
		case INTERNET_EXPLORER:
			...
			System.setProperty("webdriver.ie.driver",
					System.getProperty("user.dir")+Util.getFileSeparator()+"drivers"+Util.getFileSeparator()+"IEDriverServer.exe");
		...
		case EDGE:
			...
			System.setProperty("webdriver.edge.driver",
					System.getProperty("user.dir")+Util.getFileSeparator()+"drivers"+Util.getFileSeparator()+"WebDriver.exe"); // Update Name
